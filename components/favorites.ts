  ...
  connectedCallback() {
    this.innerHTML = `
      <div class="container">
        ...
        <div class="fav">
          <h2>Favorite</h2>
          <a title="GMail" href="https://mail.google.com/mail/u/0/#inbox" target="_blank">
          ...
          <a title="Zerotier" href="https://my.zerotier.com/network/e3918db483674dee" target="_blank">
          ...
          <a title="Metacubexd" href="http://127.0.0.1:9090/ui/#/proxies" target="_blank">
